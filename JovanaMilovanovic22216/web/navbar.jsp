...
<html lang="sr">
    ...
    <style>
        .background-image {
            position: fixed;
            background-image: url( 'https://images.pexels.com/photos/338504/pexels-photo-338504.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940' );
    ...
    <body> 
       <div class="background-image"></div>
        ...
        %>             
        <nav class="navbar navbar-expand-lg navbar-dark" style="background: rgb(0, 51, 102)">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="index.jsp"><i class="fa fa-hotel fa-2x"></i></a>
                    </li>
                </ul>
