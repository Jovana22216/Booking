<%-- 
    Document   : EditHotel
    Created on : 16-Sep-2019, 17:02:44
    Author     : Jovana
--%>
...
<html>
    ...
    <body style="color:darkgreen; font-weight:bold">
         ...
         <form   action="EditHotel" method="post" enctype="multipart/form-data">
           ...
           <div style="padding-left:5%">
              <table style="margin-top: -14%; text-align: right; display:inline-block">
               ...
               <input type="submit" value ="Izmeni" class="btn btn-success" style=" background-color:darkgreen; margin-left: 40%">
                  ...
                  <table style=" text-align: right; float:left;" >
                   <tr>
                     <div class="form-inline">
                      ...
                      <td style="padding-top:2%">  <input type="submit" style="float:left; margin-left:10%; background-color:darkgreen" value ="Kreiraj"  class="btn btn-success" ><br> <br> </td>
                     </div>
                   </tr>
                 ...
                 <%for (TipSobe tipSobe:  new TipSobeRepo().lista(HotelID)){  {%>                   
                  <br>
                   ...
                   <%} }  %>  <br>
                      ...
                      <td style="padding-top:2%">  <input type="submit" style="float:left; background-color:darkgreen; margin-left:10%" value ="Obriši" class="btn btn-danger" ><br> <br> </td>                                
                   </form>
                    </div>
               </table>                       
            </div>  
